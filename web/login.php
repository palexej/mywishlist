...
<body >
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			...
			<ul class="navbar-nav ">
				<li class="nav-item">
					<a class="nav-link" href="http://awishlist/authAndLogin/signup ">
			...
			<ul class="navbar-nav ">
				<li class="nav-item">
					<a class="nav-link" href="http://awishlist/authAndLogin/login ">
...
if ( isset($data['do_login']) )
{
	...
	if ($user)
	{
		...
		if ( password_verify($data['password'], $user->password) )//обратная дешифровка
		{
			...
			header('Location: http://awishlist/authAndLogin/upload ');
		}
		else
		{
...
<div class="row">
	<div class="col-md-4 offset-md-4 text-center  text-center loginForm">
		<h2>Вход</h2>
		<form action="http://awishlist/authAndLogin/login" method="POST">
